...
require_once('auth.php');
 $ACCESS_PWD='password'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access
...
function get_rand_str($len){
 ...
 for($i=0;$i<$len;$i++) $result.=$chars[rand(0,count($chars)-1)];//aitoc small fix
 return $result;
}
