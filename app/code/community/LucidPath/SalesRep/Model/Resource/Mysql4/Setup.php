 ...
 * @author	   Yuriy Malov
 * @copyright  Copyright (c) 2012 Lucid Path Consulting (http://www.lucidpathconsulting.com/)
 */

class LucidPath_SalesRep_Model_Resource_Mysql4_Setup extends Mage_Core_Model_Resource_Setup {
}
?>