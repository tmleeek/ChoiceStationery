...
class LucidPath_SalesRep_OnepageController extends Mage_Checkout_OnepageController {
    ...
    if (Mage::getStoreConfig('salesrep/module_status/enabled') && Mage::getStoreConfig('salesrep/step_setup/step_enabled')) {
      ...
      if ($this->getRequest()->isPost()) {
        ...
        if (Mage::getStoreConfig('salesrep/module_status/enabled') && Mage::getStoreConfig('salesrep/step_setup/step_enabled')) {
          ...
          Mage::getSingleton('core/session')->setData('salesrep_admin_id', '');
  ...
  public function saveSalesrepAction() {
    $this->_expireAjax();
    if ($this->getRequest()->isPost()) {
      Mage::getSingleton('core/session')->setData('salesrep_admin_id', $this->getRequest()->getPost('salesrep_name'));
