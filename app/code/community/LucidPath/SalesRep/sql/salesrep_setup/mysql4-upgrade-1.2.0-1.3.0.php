 ...
 *
 * @category   LucidPath
 * @package    LucidPath_SalesRep Pro
 * @author     Yuriy Malov
...
$installer->getConnection()->addColumn($installer->getTable('customer/entity'), 'salesrep_admin_id', 'INT(10)');

$installer->getConnection()->addColumn($installer->getTable('admin/user'), 'salesrep_commission_rate', 'DECIMAL(5,2)');

$installer->run("
CREATE TABLE IF NOT EXISTS `{$this->getTable('salesrep')}` (
  salesrep_id int(10) unsigned NOT NULL auto_increment,
  order_id int(10) unsigned not null,
  commission_status varchar(50) default 'unpaid',
  commission_earned DECIMAL(5,2),
  admin_id int(10),
