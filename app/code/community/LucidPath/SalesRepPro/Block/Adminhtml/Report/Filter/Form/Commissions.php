<?php
class LucidPath_SalesRepPro_Block_Adminhtml_Report_Filter_Form_Commissions extends Mage_Adminhtml_Block_Widget_Form {
  ...
  protected function _prepareForm() {
    ...
    $admins = LucidPath_SalesRepPro_Model_Source_UsersList::toOptionArray();
