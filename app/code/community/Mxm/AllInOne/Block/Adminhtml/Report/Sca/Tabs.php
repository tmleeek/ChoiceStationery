<?php
class Mxm_AllInOne_Block_Adminhtml_Report_Sca_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addTab('summary', array(
            ...
            'content'   => Mage::helper('mxmallinone/report')
                ->getIframeHtml(Mxm_AllInOne_Helper_Report::TYPE_SCA, 'summary'),
            'active'    => true
        ));
        ...
        $this->addTab('activity', array(
            ...
            'url'       => $this->getUrl(
                ...
                array(
                    '_current'    => true,
                    'report-type' => Mxm_AllInOne_Helper_Report::TYPE_SCA,
                    'report'      => 'activity'
                )
            ),
            'class'     => 'ajax'
        ...
        $this->addTab('stages', array(
            'label'     => $this->__('Stages of Abandonment'),
            'url'       => $this->getUrl(
                'mxmallinone/report/iframe',
                array(
                    '_current'    => true,
