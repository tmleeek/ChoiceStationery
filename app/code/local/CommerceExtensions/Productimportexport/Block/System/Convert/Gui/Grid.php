...
class CommerceExtensions_Productimportexport_Block_System_Convert_Gui_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('dataflow/profile_collection')
            ->addFieldToFilter('is_commerce_extensions', 1);
