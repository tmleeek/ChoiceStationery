...
//                $requestData = Mage::app()->getRequest();

//                if (isset($requestData['payment'])) {
//                    $requestData['payment']['cc_number'] = 'XXXXXXXXXXXXX';
//                    $requestData['payment']['cc_cid'] = 'XXX';
//                }
                ...
                //Sage_Log::log(print_r($requestData, true), null, $logfileName);
