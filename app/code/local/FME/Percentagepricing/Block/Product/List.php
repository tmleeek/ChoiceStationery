 ...
 */
class FME_Percentagepricing_Block_Product_List extends Mage_Catalog_Block_Product_Abstract
{
    /**
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
            ...
            foreach( $this->_productCollection as $product )
            {
                ...
                $_origPrice = $_product->getData('price');
                ...
                if($ruleEnable==1):
                    ...
                    if($collection->getData()!=NULL)
                    {
                        ...
                        if($result=="1")
                        {
                            ...
                            $product->setPrice($_origPrice);
                            $product->setSpecialPrice($new_price);
                            $product->setMinimalPrice($new_price);
                            $product->setMinPrice($new_price);
                            $product->setFinalPrice($new_price);
                        }
                        else
                        {
                            $product->setIsSuperMode(true);
                            $product->setSpecialPrice($_oldPrice);
    ...
    {
       /* echo "<pre>";
          print_r($this->_getProductCollection()->getData()); exit();*/
