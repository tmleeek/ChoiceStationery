    ...
    protected function _saveOrder()
    {
        ...
        try {
        	...
        	if ($this->isFormkeyValidationOnCheckoutEnabled() && !$this->_validateFormKey()) {
        		$tmpErrStr = "Please contact support@onestepcheckout.com. form_key check was not successful. SUPEE9767 validation failed.";
        		Mage::throwException(Mage::helper('checkout')->__($tmpErrStr));
