...
class MageWorx_Adminhtml_Block_Customerplus_Customer_Edit_Tab_Renderer_Rowtotal extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    public function render(Varien_Object $row)
    {
		$block = Mage::app()->getLayout()
			->createBlock('mageworx/customerplus_sales_items_default')
			->setTemplate('customerplus/purchases/grid-renderer-rowtotal.phtml')
