...
class Magestore_Pdfinvoiceplus_Model_Template02_Entity_Creditmemo extends Magestore_Pdfinvoiceplus_Model_Entity_Abstract
{
    private $_creditmemoId = null;
    public function _construct()
    {
        parent::_construct();
        $this->_init('pdfinvoiceplus/template02_entity_creditmemo');
    }
