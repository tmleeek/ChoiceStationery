...
class Rock_CoreOverride_Adminhtml_Promo_CatalogController extends Mage_Adminhtml_Promo_CatalogController{
    ...
    public function saveAction()
    {
        if ($this->getRequest()->getPost()) {
            try {
                ...
                $write->update(
                            "catalogrule",
                            array("website_ids" => implode(",",$data['website_ids']), "customer_group_ids" => implode(",",$data['customer_group_ids'])),
                            "rule_id=".$model->getId()
                    );
