...
class Webtex_CustomerGroupsPrice_Model_Catalog_Product_Type_Configurable_Price extends Webtex_CustomerGroupsPrice_Model_Catalog_Product_Type_Configurable_Price_Abstract
{
	...
	$customer = Mage::getSingleton('customer/session')->getCustomer();
        ...
        foreach ($attributes as $attribute) {
	        ...
	        $finalPrice = $finalPrice + $this->_calcSelectionPrice($value, $originalPrice);
	    }
