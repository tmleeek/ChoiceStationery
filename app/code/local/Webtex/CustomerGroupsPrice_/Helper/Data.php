...
class Webtex_CustomerGroupsPrice_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    const XML_CUSTOMERGROUPSPRICE_USE_PRICERULES = 'webtex_catalog/customergroupsprice/price_rules';
    ...
    public function isUsePriceRules() {
        return Mage::getStoreConfigFlag(self::XML_CUSTOMERGROUPSPRICE_USE_PRICERULES);
    }
