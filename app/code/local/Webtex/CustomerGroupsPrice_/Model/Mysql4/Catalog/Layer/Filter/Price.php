            ...
            $col = "IFNULL(
                        IF(
                            ...
                            IF(
                                ...
                                IF(e.final_price IS NULL,e.min_price * (100 + cgp_sprices.price) / 100 ,e.final_price * (100 + cgp_sprices.price) / 100),
                                IF(e.final_price IS NULL,e.min_price * cgp_sprices.price / 100,e.final_price * cgp_sprices.price / 100)
                            ),
                            IF(
                                SUBSTRING(cgp_sprices.price, 1, 1) IN ('+', '-'),
                                IF(e.final_price IS NULL,e.min_price + cgp_sprices.price,e.final_price + cgp_sprices.price),
                                cgp_sprices.price
                            )
                        )
                    , IFNULL(
                        IF(
                            ...
                            IF(
                                ...
                                IF(e.final_price IS NULL,e.min_price * (100 + cgp_prices.price) / 100 ,e.final_price * (100 + cgp_prices.price) / 100),
                                IF(e.final_price IS NULL,e.min_price * cgp_prices.price / 100,e.final_price * cgp_prices.price / 100)
                            ),
                            IF(
                                SUBSTRING(cgp_prices.price, 1, 1) IN ('+', '-'),
                                IF(e.final_price IS NULL,e.min_price + cgp_prices.price,e.final_price + cgp_prices.price),
                                cgp_prices.price
                            )
                        )
                    ,
                    IF(
                        ...
                        IF(
                            ...
                            IF(
                                ...
                                IF(e.final_price IS NULL,e.min_price * (100 + cgp_global.price) / 100 ,e.final_price * (100 + cgp_global.price) / 100),
                                IF(e.final_price IS NULL,e.min_price * cgp_global.price / 100,e.final_price * cgp_global.price / 100)
                            ),
                            IF(
                                SUBSTRING(cgp_global.price, 1, 1) IN ('+', '-'),
                                IF(e.final_price IS NULL,e.min_price + cgp_global.price,e.final_price + cgp_global.price),
                                cgp_global.price
                            )
                        )
                    )))";
