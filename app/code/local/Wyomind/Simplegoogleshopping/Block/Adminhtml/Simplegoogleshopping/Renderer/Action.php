...
class Wyomind_Simplegoogleshopping_Block_Adminhtml_Simplegoogleshopping_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Action {
    ...
    public function render(Varien_Object $row) {
        $this->getColumn()->setActions(
                array(
                    array(
                        'url' => $this->getUrl('*/simplegoogleshopping/generate', array('simplegoogleshopping_id' => $row->getSimplegoogleshoppingId())),
                    ...
                    array(
                        'url' => $this->getUrl('*/simplegoogleshopping/edit', array('id' => $row->getSimplegoogleshoppingId())),
                        'caption' => Mage::helper('simplegoogleshopping')->__('Edit'),
                    ),
                    array(
                        'url' => $this->getUrl('*/simplegoogleshopping/sample', array('simplegoogleshopping_id' => $row->getSimplegoogleshoppingId(), 'limit' => 10)),
                     ...
                     array(
                        'url' => $this->getUrl('*/simplegoogleshopping/showReport', array('simplegoogleshopping_id' => $row->getSimplegoogleshoppingId())),
                        'caption' => Mage::helper('simplegoogleshopping')->__('Show report') ,
                        'popup' => true
                    ),
                    array(
                        'url' => $this->getUrl('*/simplegoogleshopping/delete', array('id' => $row->getSimplegoogleshoppingId())),
