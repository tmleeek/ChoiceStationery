...
CREATE TABLE {$this->getTable('simplegoogleshopping')} (
 `simplegoogleshopping_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `simplegoogleshopping_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
(1, 'GoogleShopping_standard.xml', '/', '2011-07-10 20:26:36', 1, 'http://wwww.website.com', 'Data feed title', 'Data feed description', '<g:id>{sku}</g:id>
...
(2, 'GoogleShopping_configurable_products.xml', '/', '2011-08-01 12:00:00', 1, 'http://wwww.website.com', 'Export for configurable products', 'This template is designed to publish the different variants of all configurable, grouped or bundle products.','<g:id>{sku}</g:id>
{G:ITEM_GROUP_ID}
<title>{name,[substr],[70],[...]}</title>
...
(3, 'Special_StockInTheChannel.xml', '/', '2011-07-10 20:26:36', 1, 'http://wwww.website.com', 'Data feed title', 'Stock In The Channel Template', '<g:id>{sku}</g:id>
<title>{name,[substr],[70],[...]}</title>
...
{SC:EAN}', '*', 'simple', '2,3,4', '[{\"line\":\"0\",\"checked\":true,\"code\":\"price\",\"condition\":\"gt\",\"value\":\"0\"},{\"line\":\"1\",\"checked\":true,\"code\":\"sku\",\"condition\":\"notnull\",\"value\":\"\"},{\"line\":\"2\",\"checked\":true,\"code\":\"name\",\"condition\":\"notnull\",\"value\":\"\"},{\"line\":\"3\",\"checked\":true,\"code\":\"small_image\",\"condition\":\"neq\",\"value\":\"\"},{\"line\":\"4\",\"checked\":true,\"code\":\"ean\",\"condition\":\"notnull\",\"value\":\"\"},{\"line\":\"5\",\"checked\":true,\"code\":\"description\",\"condition\":\"notnull\",\"value\":\"\"},{\"line\":\"6\",\"checked\":true,\"code\":\"description\",\"condition\":\"neq\",\"value\":\"\"},{\"line\":\"7\",\"checked\":false,\"code\":\"cost\",\"condition\":\"eq\",\"value\":\"\"},{\"line\":\"8\",\"checked\":false,\"code\":\"cost\",\"condition\":\"eq\",\"value\":\"\"},{\"line\":\"9\",\"checked\":false,\"code\":\"cost\",\"condition\":\"eq\",\"value\":\"\"},{\"line\":\"10\",\"checked\":false,\"code\":\"cost\",\"condition\":\"eq\",\"value\":\"\"}]');
