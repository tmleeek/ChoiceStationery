...
class Wyomind_Watchlogpro_Adminhtml_WatchlogproController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $this->loadLayout()->_setActiveMenu('system/watchlog')->_addBreadcrumb(
            Mage::helper('adminhtml')->__('Watchlogpro Manager'), Mage::helper('adminhtml')->__('Watchlogpro Manager')
        );
        return $this;
    }
