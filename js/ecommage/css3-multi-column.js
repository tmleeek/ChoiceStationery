...
// This software is licensed under the CC-GNU LGPL <http://web.archive.org/web/20130428094131/http://creativecommons.org/licenses/LGPL/2.1/>

// For additional information, see : http://web.archive.org/web/20130428094131/http://www.csscripting.com/
...
function CSS3MultiColumn() {
	...
	function loadStylesheets() {
		if(document.styleSheets) {	// Firefox & IE
			...
			//web.archive.org/web/20130428094131/http://var/ St = document.getElementsByTagName('style');
		}
	}
	...
	function loadCssCache(s, callback) {
		...
		if (s.href && typeof XMLHttpRequest!='undefined') {	
			...
			xmlhttp.open("GET", s.href, true); //web.archive.org/web/20130428094131/http://synchrone/ transaction crashes Opera 8.01
			xmlhttp.send(null);
		}
	}
	...
	function processElement(affectedElement, column_count, column_width, column_gap, column_rule ) {
		//web.archive.org/web/20130428094131/http://affectedElement.style.visibility/ = 'hidden';
		var widthUnit;
		var width;
		var column_rule_width = 0;
		
		// Get available width
		// see http://web.archive.org/web/20130428094131/http://www.csscripting.com/css-multi-column/dom-width-height.php
		...
		// see http://web.archive.org/web/20130428094131/http://msdn.microsoft.com/workshop/author/om/measuring.asp
		...
		if(affectedElement.clientWidth && affectedElement.clientWidth != 0) {			
			...
			if(affectedElement.currentStyle) {
				...
				//web.archive.org/web/20130428094131/http://padding/ = parseInt(window.getComputedStyle(affectedElement,"").getPropertyValue("padding-left").replace(/[\D]*/gi,"")) + parseInt(window.getComputedStyle(affectedElement,"").getPropertyValue("padding-left").replace(/[\D]*/gi,""))  
			} 
		...
		// Create a wrapper
		var wrapper = document.createElement('div'); //web.archive.org/web/20130428094131/http://affectedElement.tagName/
		...
		//web.archive.org/web/20130428094131/http://wrapper.style.border/ = "1px solid #F00";
		wrapper.className = elem.className;
		elem.className = "";
		// since all columns will be left-floating we need to clear the floats after them.
		//web.archive.org/web/20130428094131/http://wrapper.style.overflow/ = 'auto';
		...
		//web.archive.org/web/20130428094131/http://elem.style.padding/ = "0";
		//web.archive.org/web/20130428094131/http://elem.style.margin/ = "0"; 
		...
		//web.archive.org/web/20130428094131/http://wrapper.style.minHeight/ = newHeight + 'px';
		//if(document.all && !window.opera)
			//web.archive.org/web/20130428094131/http://wrapper.style.height/ = newHeight + 'px';
		...
		if(elem) {//web.archive.org/web/20130428094131/http://mainly/ to set the column rule at the right height.
			if(document.all && !window.opera)
				elem.style.height = newHeight+'px';
			elem.style.minHeight = newHeight+'px';  
		}
		...
		//web.archive.org/web/20130428094131/http://wrapper.style.visibility/ = 'visible'; 				
	}
...
// see http://web.archive.org/web/20130428094131/http://dean.edwards.name/my/cssQuery.js.html
/*
    License: http://web.archive.org/web/20130428094131/http://creativecommons.org/licenses/by/1.0/
    Author:  Dean Edwards/2004
    Web:     http://web.archive.org/web/20130428094131/http://dean.edwards.name/
*/
...
CSS3Utility.prototype.XBrowserAddEventHandler = function(target,eventName,handlerName) {      
	...
	// see http://web.archive.org/web/20130428094131/http://weblogs.asp.net/asmith/archive/2003/10/06/30744.aspx
...
/*
     FILE ARCHIVED ON 09:41:31 Apr 28, 2013 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 06:55:22 May 24, 2017.
