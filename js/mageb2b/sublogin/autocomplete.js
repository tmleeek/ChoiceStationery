...
var Autocomplete = function(el, choices, options){
  this.el = $(el);
...
Autocomplete.prototype = {
  ...
  getSuggestions: function() {
      var re = new RegExp(this.currentValue, 'i');
      this.suggestions = [];
      this.data = [];
      for (var i in this.choices) {
        if(re.test(this.choices[i].label)) {
          this.suggestions.push(this.choices[i].label);
          this.data.push(this.choices[i].id);
        }
      }
      this.suggest(); 
  },
